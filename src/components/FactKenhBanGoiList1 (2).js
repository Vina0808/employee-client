  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', padding: '10px' }}>
      <h2 style={{ backgroundColor: '#007BFF', color: 'white', padding: '10px', borderRadius: '5px', textAlign: 'center' }}>
        📊 Dữ liệu Tổng Kênh Bán Hàng BPC
      </h2>
        ...
        <div>
          ...
          <table style={{ width: '100%', fontSize: '14px', borderCollapse: 'collapse', border: '1px solid #ccc' }}>
            <thead style={{ backgroundColor: '#f2f2f2' }}>
              <tr>
                {['STT', 'Phòng BH', 'HRM BH', 'Phòng ban HRM', 'Nhân viên', 'Số TB', 'User BH', 'Ngày BH', 'Gói cước', 'Chu kỳ gói', 'Giá gói', 'Loại TB Tháng', 'Hình thức TB', 'Công cụ bán gói', 'Thuê bao HVC', 'Loại giao dịch', 'Tháng DL'].map((header, idx) => (
