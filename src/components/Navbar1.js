...
function MyNavbar() {
  return (
    ...
    >
      <Navbar expand="lg" variant="dark" className="shadow" fixed="top">
        <Container fluid>
            ...
            <Nav className="me-auto">
              ...
              <NavDropdown title="Thông tin cá nhân" id="nav-dropdown-personal-info">
                ...
                <NavDropdown title="Lương nhân viên" id="nav-dropdown-employee-salary" drop="end">
                  ...
                  <NavDropdown.Item as={Link} to="/app/salary-by-package/bangoi">Lương theo gói BANGOI</NavDropdown.Item>
                ...
                {/* ✅ Dữ liệu bán hàng nhân viên có thêm FACT_HQKD */}
                <NavDropdown title="Dữ liệu bán hàng nhân viên" id="nav-dropdown-sales-data" drop="end">
                  ...
                  <NavDropdown.Item as={Link} to="/app/fact-hqkd-kenh-ban-goi">
                    📊 FACT_HQKD Kênh bán gói
                      </NavDropdown.Item>
              ...
              <NavDropdown title="Dữ liệu" id="nav-dropdown-data">
                ...
                <NavDropdown.Item as={Link} to="/app/upload-sales">Upload: Bảng bán hàng</NavDropdown.Item>
